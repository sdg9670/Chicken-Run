...
public class ClearLaser : MonoBehaviour
{
    private ClearControllerManager _controller = null;
    public Vector3 _hit_point;
    // Start is called before the first frame update
    void Start()
    {
        _controller = this.transform.parent.GetComponent<ClearControllerManager>();
    }
