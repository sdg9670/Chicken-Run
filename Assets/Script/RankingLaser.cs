...
public class RankingLaser : MonoBehaviour
{
    private RankingControllerManager _controller = null;
    public Vector3 _hit_point;
    // Start is called before the first frame update
    void Start()
    {
        _controller = this.transform.parent.GetComponent<RankingControllerManager>();
    }
